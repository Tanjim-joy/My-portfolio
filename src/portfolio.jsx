  ...
  const projects = [
    {
      ...
      description:
        'A comprehensive web application for managing coaching center operations including student enrollment, course management, attendance tracking, and performance analytics.',
    ...
    },
    {
      ...
      description:
        'A robust inventory management solution for tracking stock levels, managing suppliers, and generating comprehensive business reports.',
      ...
      liveLink:
        'https://inventorysys.bsite.net/Identity/Account/Login',
      type: 'business',
    },
  ];
  ...
  const experiences = [
    {
      ...
      period: 'Present',
      description:
        'Leading the Manufacturing Automations team in developing robust, scalable web applications that drive operational efficiency and digital transformation in manufacturing processes.',
      achievements: [
    ...
    },
    {
      ...
      period: '2022 - Present',
      description:
        'Developed business-critical web applications supporting manufacturing operations with focus on scalability and efficiency.',
      achievements: [
  ...
  return (
    ...
    >
            ...
            {[
              ...
              <motion.button
                ...
                style={{
                  ...
                  paddingBottom: '4px',
                  color:
                    activeSection === item ? '#a855f7' : '#cbd5e1',
      ...
      <section
        style={{
          padding:
            'clamp(4rem, 15vh, 10rem) clamp(1rem, 4vw, 2rem) clamp(4rem, 10vh, 8rem)',
          position: 'relative',
          overflow: 'hidden',
        }}
      >
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Building robust, scalable web applications that drive
                operational efficiency and digital transformation in
              ...
              >
                <motion.button
                  ...
                  style={{
                    padding:
                      'clamp(0.5rem, 2vw, 0.875rem) clamp(1rem, 3vw, 2.25rem)',
                    background:
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                I am currently serving as Deputy Assistant Director in
                the Manufacturing Automations team at WALTON Hi-Tech
                Industries PLC, within the WALTON ICT Department. With{' '}
                {years} years of professional experience, I specialize
                in developing robust, scalable, and business-critical
                web and desktop applications that drive operational
                efficiency and digital transformation in manufacturing
                processes. I have hands-on experience designing
                end-to-end solutions—requirements collection, system
                design, implementation, testing, and
                deployment—focused on real business impact and
              ...
              >
                {[
                  ...
                  },
                  {
                    icon: <Briefcase />,
                    label: 'Current Role',
                    value: 'Deputy Assistant Director',
                  },
                  {
                    icon: <Calendar />,
                    label: 'Industry',
                    value: 'Manufacturing Tech',
                  },
                ].map((item, index) => (
                  <div
                    key={index}
                ...
                {[
                  {
                    ...
                    desc: 'Designing scalable, maintainable systems for enterprise applications',
                  },
                  {
                    title: 'Process Optimization',
                    desc: 'Streamlining manufacturing workflows through digital solutions',
                  },
                  {
                  ...
                  },
                  {
                    ...
                    desc: 'Bridging technical and business requirements effectively',
                  },
                ].map((item, index) => (
                  <div
                    key={index}
                  ...
                  {[
                    {
                      ...
                      color: '#7c3aed',
                      hoverColor: '#9333ea',
                      link: 'https://github.com/Tanjim-joy',
                    },
                    {
                      icon: Linkedin,
                      color: '#3b82f6',
                      hoverColor: '#60a5fa',
                      link: 'https://www.linkedin.com/in/tangimul/',
                    },
                    {
                      icon: MessageCircle,
                      color: '#25D366',
                      hoverColor: '#2563eb',
                      link: 'https://wa.me/8801838120302',
                    },
                  ].map((social, i) => (
                    <motion.a
                      key={i}
                ...
                <div>
                  ...
                  <input
                    ...
                    style={{
                      ...
                      borderRadius: '1rem',
                      padding:
                        'clamp(0.75rem, 2vw, 1rem) clamp(1rem, 3vw, 1.5rem)',
                      color: 'white',
                      fontSize: 'clamp(0.9rem, 2.5vw, 1.1rem)',
                      outline: 'none',
                    }}
